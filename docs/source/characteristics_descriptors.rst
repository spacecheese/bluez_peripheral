...
If you find that a characteristic or descriptor read or write access is invalid or not permitted for some reason you should raise a :class:`dbus_next.DBusError` with a type string recognised by bluez.
